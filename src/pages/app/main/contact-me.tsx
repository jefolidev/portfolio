...
export function ContactMe() {
  return (
    <div className="bg-lightPrimary min-h-full w-full select-none p-3 transition-colors dark:bg-primary">
      <div className="bg-lightSecondary xs:h-[29rem] xs:px-8 xs:gap-32 xs:py-4 xs:grid-cols-1 xs:justify-center grid min-h-full w-full items-center rounded-lg transition-colors sm:grid-cols-2 sm:justify-between lg:px-48 dark:bg-secondary">
